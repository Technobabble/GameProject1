...
if(l12515D7C_0)
{
	...
	if(l681D8F7D_0)
	{
		...
		/// @DnDHash : 4195956C
		/// @DnDParent : 681D8F7D
		/// @DnDArgument : "x" "obj_wobbler.x + dcos(obj_wobbler.wobble_angle) * 100"
		/// @DnDArgument : "y" "obj_wobbler.y +dsin(obj_wobbler.wobble_angle)* 100"
		x = obj_wobbler.x + dcos(obj_wobbler.wobble_angle) * 100;
		y = obj_wobbler.y +dsin(obj_wobbler.wobble_angle)* 100;
	}
}